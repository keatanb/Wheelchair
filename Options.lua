...
local function createCheckBox(parent, anchor, number, property, label, tooltip)
	local checkbox = CreateFrame("CheckButton", "WheelchairCheckBox" .. number, parent, "ChatConfigCheckButtonTemplate")
...
function frame:CreateOptions()
	...
	local autoSellSoulboundOnly = createCheckBox(self, title, 8, SoulboundOnly, "Restrict to Soulbound Items", "Only allow Wheelchair to automatically mark soulbound items for sale (does not restrict grey items, naturally).")
